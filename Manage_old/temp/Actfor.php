        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <?php if ($cid == 5) { ?>
                    ...
                    <td width="60"><a
                            href="Account_Member.php?cid=<?php echo $cid ?>&sid=1">新增<?php echo $Rank[1] ?></a></td>
                    <?php if ($LoginId != 48 && $ConfigModel['g_son_member_lock'] == 1) { ?>
                        <td width="18"><img src="images/22.gif" width="14" height="14"/></td>
                        <td width="90"><a
                                href="Account_Member.php?cid=<?php echo $cid ?>&sid=2">新增直屬<?php echo $Rank[1] ?></a>
                        </td>
                    <?php }
                } else { ?>
                    <td width="18"><img src="images/22.gif" width="14" height="14"/></td>
    ...
    <table border="0" cellspacing="0" class="conter">
        ...
        <?php if (!$result) { ?>
            ...
            <?php for ($i = 0; $i < count($result); $i++) { ?>
                ...
                ?>
                <tr align="center" style="height:28px" onmouseover="this.style.backgroundColor='#FFFFA2'"
                    ...
                    <td align="right" style="font-size:104%"><?php echo is_Number($result[$i]['g_money'], 0); ?>
                        &nbsp;</td>
                    <td align="right"
                        style="font-size:104%"><?php echo is_Number($result[$i]['g_money'] - $userModel->SumMoney($result[$i]['g_nid'] . $like), 0); ?>
                        &nbsp;</td>
                    ...
                    <td><?php $cc = explode(' ', $result[$i]['g_date']);
                        echo $cc[0]; ?></td>
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="nones" width="14" height="18"><img src="/Manage/temp/images/edt.gif"/></td>
                                <td class="nones" width="30"><a
                                        href="Account_MR.php?cid=<?php echo $cid ?>&uid=<?php echo $result[$i]['g_name'] ?>">退水</a>
                                </td>
                                <td class="nones" width="15"><img src="/Manage/temp/images/edit.gif"/></td>
                                <td class="nones" width="30"><a
                                        href="Account_Up.php?cid=<?php echo $cid ?>&uid=<?php echo $result[$i]['g_name'] ?>">修改</a>
                                </td>
                                <td class="nones" width="16"><img src="/Manage/temp/images/55.gif"/></td>
                                <td class="nones" width="30"><a
                                        href="LoginLog.php?uid=<?php echo $result[$i]['g_name'] ?>">日誌</a></td>
                                <td class="nones" width="16"><img src="/Manage/temp/images/44.gif"/></td>
                                <td class="nones" width="26"><a
                                        href="Amend_Log.php?uid=<?php echo $result[$i]['g_name'] ?>">記錄</a></td>
                                <?php if ($LoginId == 89 && !isset($Users[0]['g_lock_1'])) { ?>
                                    <td class="nones" width="16"><img src="/Manage/temp/images/del.gif"/></td>
                                    <td class="nones" width="26"><a href="javascript:void(0)"
                                                                    onclick="locationFile1('<?php echo $result[$i]['g_name'] ?>','2')">刪除</a>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
                    ...
                    <td>
                        <input type="button" name="ut<?php echo $i ?>" id="ut<?php echo $i ?>"
                               onclick="locationFile(<?php echo $i ?>);"
                               value="<?php if ($result[$i]['g_lock'] == 1) echo '啟用';
                               if ($result[$i]['g_lock'] == 2) echo '凍結';
                        ...
                        <div id="oddsPops<?php echo $i ?>" style="position:absolute;width:190px;display:none">
                            <table border="0" cellspacing="0" class="t_odds" width="100%">
                                <tr class="tr_top">
                                    ...
                                    <th width="27%" align="right"><img src="/Manage/temp/images/del.gif"
                                                                       onclick="diplaydiv(<?php echo $i ?>);"
                                                                       title="关闭"/></th>
                                </tr>
                                <tr class="text" style="height:35px;text-align:center">
                                    <td id="showPas<?php echo $i ?>" colspan="2">
                                        <input name="lock<?php echo $i ?>" type="radio"
                                               value="1" <?php if ($result[$i]['g_lock'] == 1) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',1,<?php echo $i ?>);"/>
                                        啟用&nbsp;
                                        <input name="lock<?php echo $i ?>" type="radio"
                                               value="2" <?php if ($result[$i]['g_lock'] == 2) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',1,<?php echo $i ?>);"/>
                                        凍結&nbsp;
                                        <input name="lock<?php echo $i ?>" type="radio"
                                               value="3" <?php if ($result[$i]['g_lock'] == 3) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',1,<?php echo $i ?>);"/>
                                        停用&nbsp;
            ...
            <?php for ($i = 0; $i < count($result); $i++) { ?>
                ...
                <tr align="center" style="height:28px" onmouseover="this.style.backgroundColor='#FFFFA2'"
                    ...
                    <td align="right" style="font-size:104%"><?php echo is_Number($result[$i]['g_money'], 0); ?>
                        &nbsp;</td>
                    <td align="right"
                        style="font-size:104%"><?php echo is_Number($result[$i]['g_money'] - $userModel->SumMoney($result[$i]['g_nid'], true), 0); ?>
                        &nbsp;</td>
                    <td><?php echo '<a href="Actfor.php?cid=5&name=' . $result[$i]['g_name'] . '&level=4" target="mainFrame">' . $userModel->SumCount($result[$i]['g_nid'] . '%', true) . '個</a>'; ?></td>
                    <td><?php $cc = explode(' ', $result[$i]['g_date']);
                        echo $cc[0]; ?></td>
                                    ...
                                    <td id="showPas<?php echo $i ?>" colspan="2">
                                        ...
                                        <input name="lock<?php echo $i ?>" type="radio"
                                            ...
                                            echo 'checked="checked"';
                                               ...
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',1,<?php echo $i ?>);"/>
                                        凍結&nbsp;
                                        <input name="lock<?php echo $i ?>" type="ralock'] == 3) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',1,<?php echo $i ?>);"/>
                                        停用&nbsp;
        ...
        <?php if (!$result) { ?>
            ...
            <?php for ($i = 0; $i < count($result); $i++) { ?>
                ...
                <tr align="center" style="height:28px" onmouseover="this.style.backgroundColor='#FFFFA2'"
                    ...
                    <td><?php echo $k //上级gudong?></td>
                    <td><?php echo $l //上级gudong占成?>%</td>
                    <td><?php echo $n; //上级zongdaili?></td>
                    <td><?php echo $p //上级zongdaili占成?>%</td>
        ...
        <?php if (!$result) { ?>
            ...
            <?php for ($i = 0; $i < count($result); $i++) { ?>
                ...
                <tr align="center" style="height:28px" onmouseover="this.style.backgroundColor='#FFFFA2'"
                    ...
                    <td><?php echo $result[$i]['g_f_name']; ?></td>
                    <td align="right" style="font-size:104%"><?php echo is_Number($result[$i]['g_money']); ?>&nbsp;</td>
                    <td align="right" style="font-size:104%"><?php echo is_Number($result[$i]['g_money_yes']); ?>
                        &nbsp;</td>
                    <td><?php $s = explode(' ', $result[$i]['g_date']);
                        echo $s[0]; ?></td>
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="nones" width="14" height="18"><img src="/Manage/temp/images/edt.gif"/></td>
                                <td class="nones" width="30"><a
                                        href="Member_MR.php?cid=<?php echo $cid ?>&uid=<?php echo $result[$i]['g_name'] ?>">退水</a>
                                </td>
                                <td class="nones" width="15"><img src="/Manage/temp/images/edit.gif"/></td>
                                <td class="nones" width="30"><a
                                        href="Manage_Up.php?cid=<?php echo $cid ?>&uid=<?php echo $result[$i]['g_name'] ?>">修改</a>
                                </td>
                                <td class="nones" width="16"><img src="/Manage/temp/images/55.gif"/></td>
                                <td class="nones" width="30"><a
                                        href="LoginLog.php?uid=<?php echo $result[$i]['g_name'] ?>">日誌</a></td>
                                ...
                                <?php if ($LoginId == 89 && !isset($Users[0]['g_lock_1'])) { ?>
                                    <td class="nones" width="16"><img src="/Manage/temp/images/del.gif"/></td>
                                    <td class="nones" width="26"><a href="javascript:void(0)"
                                                                    onclick="locationFile1('<?php echo $result[$i]['g_name'] ?>','1')">刪除</a>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
                    ...
                    <td>
                        <input type="button" name="ut<?php echo $i ?>" id="ut<?php echo $i ?>"
                               onclick="locationFile(<?php echo $i ?>);"
                               value="<?php if ($result[$i]['g_look'] == 1) echo '啟用';
                               if ($result[$i]['g_look'] == 2) echo '凍結';
                               if ($result[$i]['g_look'] == 3) echo '停用';?>"/>
                        ...
                        <div id="oddsPops<?php echo $i ?>" style="position:absolute;width:190px;display:none">
                            <table border="0" cellspacing="0" class="t_odds" width="100%">
                                ...
                                <tr class="text" style="height:35px;text-align:center">
                                    <td id="showPas<?php echo $i ?>" colspan="2">
                                        <input name="lock<?php echo $i ?>" type="radio"
                                               value="1" <?php if ($result[$i]['g_look'] == 1) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',2,<?php echo $i ?>);"/>
                                        啟用&nbsp;
                                        <input name="lock<?php echo $i ?>" type="radio"
                                               value="2" <?php if ($result[$i]['g_look'] == 2) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',2,<?php echo $i ?>);"/>
                                        凍結&nbsp;
                                        <input name="lock<?php echo $i ?>" type="radio"
                                               value="3" <?php if ($result[$i]['g_look'] == 3) {
                                            echo 'checked="checked"';
                                        } ?>
                                               onclick="changeAjax(this.value,'<?php echo $result[$i]['g_name'] ?>',2,<?php echo $i ?>);"/>
                                        停用&nbsp;
