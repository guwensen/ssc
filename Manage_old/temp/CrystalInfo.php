                        ...
                        <td background="/Manage/temp/images/tab_05.gif">
                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="40">
                                    	<select id="numbers" onchange="FromSubmit(this,'1','1')">
	                                    	<option value="0" selected="selected">-----請選擇-----</option>
                                        </select>
                                	</td>
                                    <td width="45" align="right">股東：</td>
                                    <td width="40">
                                    	<select id="rank1" onchange="FromSubmit(this,'1','2')">
	                                    	<option value="0" selected="selected">----請選擇----</option>
                                    ...
                                    <td width="40">
                                    	<select id="rank2" onchange="FromSubmit(this,'1','3')">
	                                    	<option value="0" selected="selected">----請選擇----</option>
                                    ...
                                    <td width="40">
                                    	<select id="rank3" onchange="FromSubmit(this,'1','4')">
	                                    	<option value="0" selected="selected">----請選擇----</option>
                                    ...
                                    <td width="40">
                                    	<select id="member" onchange="FromSubmit(this,'1','5')">
	                                    	<option value="0" selected="selected">----請選擇----</option>
                                    ...
                                    <td>
                                        ...
                                        <input name="Find_VN" type="button" class="inputa" onclick="FromSubmit('FindType','2', '')" value="查找" />
                                    </td>
                                  </tr>
                            </table>
                        </td>
                            	...
                            	<tr style="height:30px">
                            		<td colspan="7">&nbsp;&nbsp;批量刪除：
	                            		<select id="startNumber">
	                                        ...
	                                        &nbsp;&nbsp; &nbsp;&nbsp;
                            		<img src="images/edt.gif" /><a href="Mautowin.php">会员单注必中设置</a></td>
                            	</tr>
                            	<tr class="tr_top">
