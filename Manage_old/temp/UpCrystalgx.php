...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if ($db->query($sql, 2))
	{
		$SumAmount = new SumAmountgx($arr['s_number'], false, $arr['uid'], $sum);
...
{
	$ps = false;
	$sql = "SELECT g_id FROM g_zhudan WHERE g_t_id = '{$uid}' AND g_type = '廣西快樂十分' AND g_qishu = '{$result[0]['g_qishu']}}' LIMIT 1 ";
	if ($db->query($sql, 0))
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                		<select name="s_numtype" disabled="disabled">
                                			<?php if ($result[0]['g_mingxi_1']=='一中一'||$result[0]['g_mingxi_1']=='二中二'||$result[0]['g_mingxi_1']=='三中二'||$result[0]['g_mingxi_1']=='三中三'||$result[0]['g_mingxi_1']=='四中三'||$result[0]['g_mingxi_1']=='五中三'){?>
                                			<option <?php if($result[0]['g_mingxi_1']=='一中一'){echo'selected="selected"';}?> value="一中一">一中一</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='二中二'){echo'selected="selected"';}?> value="二中二">二中二</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='三中二'){echo'selected="selected"';}?> value="三中二">三中二</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='三中三'){echo'selected="selected"';}?> value="三中三">三中三</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='四中三'){echo'selected="selected"';}?> value="四中三">四中三</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='五中三'){echo'selected="selected"';}?> value="五中三">五中三</option>
                                			...
                                			<option <?php if($result[0]['g_mingxi_1']=='特码'){echo'selected="selected"';}?> value="特码">特码</option>
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<?php }else {?>
                                		<select name="s_numcontent">
                                			...
                                			<option <?php if($result[0]['g_mingxi_2']=='神'){echo'selected="selected"';}?> value="神">神</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='奇'){echo'selected="selected"';}?> value="奇">奇</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='快'){echo'selected="selected"';}?> value="快">快</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='乐'){echo'selected="selected"';}?> value="乐">乐</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='红'){echo'selected="selected"';}?> value="红">红</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='兰'){echo'selected="selected"';}?> value="兰">兰</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='绿'){echo'selected="selected"';}?> value="绿">绿</option>
                                			<?php }?>
                                		</select>
                                	<?php }?>
									</td>
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                			<?php 
                                				if ($result[0]['g_mingxi_1']=='一中一'||$result[0]['g_mingxi_1']=='二中二'||$result[0]['g_mingxi_1']=='三中二'||$result[0]['g_mingxi_1']=='三中三'||$result[0]['g_mingxi_1']=='四中三'||$result[0]['g_mingxi_1']=='五中三'){
