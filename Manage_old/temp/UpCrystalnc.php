...
else if (isset($_GET['uid']))
{
	...
	if (!$db->query("SELECT g_qishu FROM g_history5 WHERE g_qishu = '{$result[0]['g_qishu']}' LIMIT 1 ", 0)){
		if ($db->query("SELECT g_id FROM g_kaipan5 WHERE g_qishu = '{$result[0]['g_qishu']}' LIMIT 1", 0))
			$ps = true;
		else
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                		<select name="s_numtype" disabled="disabled">
                                			<?php if ($result[0]['g_mingxi_1']=='蔬菜单选' || $result[0]['g_mingxi_1']=='动物单选' ||$result[0]['g_mingxi_1']=='幸运二'||$result[0]['g_mingxi_1']=='连连中'||$result[0]['g_mingxi_1']=='背靠背'||$result[0]['g_mingxi_1']=='幸运三'||$result[0]['g_mingxi_1']=='幸运四'||$result[0]['g_mingxi_1']=='幸运五'){?>
                                			<option <?php if($result[0]['g_mingxi_1']=='蔬菜单选'){echo'selected="selected"';}?> value="蔬菜单选">蔬菜单选</option>
											<option <?php if($result[0]['g_mingxi_1']=='动物单选'){echo'selected="selected"';}?> value="动物单选">动物单选</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='幸运二'){echo'selected="selected"';}?> value="幸运二">幸运二</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='连连中'){echo'selected="selected"';}?> value="连连中">连连中</option>
											<option <?php if($result[0]['g_mingxi_1']=='背靠背'){echo'selected="selected"';}?> value="背靠背">背靠背</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='幸运三'){echo'selected="selected"';}?> value="幸运三">幸运三</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='幸运四'){echo'selected="selected"';}?> value="幸运四">幸运四</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='幸运五'){echo'selected="selected"';}?> value="幸运五">幸运五</option>
                                			<?php } else if ($result[0]['g_mingxi_1']=='總和、家禽野兽' || $result[0]['g_mingxi_1']=='家禽野兽' || $result[0]['g_mingxi_1']=='總和') {?>
                                			<option value="總和、家禽野兽">總和、家禽野兽</option>
                                			<?php } else {?>
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<?php }else {?>
                                		<select name="s_numcontent">
                                			<?php if ($result[0]['g_mingxi_1']=='總和、家禽野兽' || $result[0]['g_mingxi_1']=='家禽野兽' || $result[0]['g_mingxi_1']=='總和') {?>
                                			...
                                			<option <?php if($result[0]['g_mingxi_2']=='家禽'){echo'selected="selected"';}?> value="家禽">家禽</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='野兽'){echo'selected="selected"';}?> value="野兽">野兽</option>
                                			<?php } else {?>
                                			...
                                			<option <?php if($result[0]['g_mingxi_2']=='梅'){echo'selected="selected"';}?> value="梅">梅</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='兰'){echo'selected="selected"';}?> value="兰">兰</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='菊'){echo'selected="selected"';}?> value="菊">菊</option>
                                			<option <?php if($result[0]['g_mingxi_2']=='竹'){echo'selected="selected"';}?> value="竹">竹</option>
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                			<?php 
                                				if ($result[0]['g_mingxi_1']=='蔬菜单选'||$result[0]['g_mingxi_1']=='动物单选'||$result[0]['g_mingxi_1']=='幸运二'||$result[0]['g_mingxi_1']=='连连中'||$result[0]['g_mingxi_1']=='背靠背'||$result[0]['g_mingxi_1']=='幸运三'||$result[0]['g_mingxi_1']=='幸运四'||$result[0]['g_mingxi_1']=='幸运五'){
