...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if ($mid == 1)
	{
		include_once ROOT_PATH.'class/UserReportInfoxj.php';
		$UserReportInfoxj = new UserReportInfoxj($Users[0]);
		$result = $UserReportInfoxj->GetNumberAll();
		$result = json_encode($result);
		$infocq = $UserReportInfoxj->GetInfocq();
...
JSON;
	...
	if ($mid == 2)
	{
		$sql = "SELECT `h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `h7`, `h8`, `h9`, `h10`, `h11`, `h12`, `h13`, `h14` FROM `g_odds8`  ORDER BY g_id ASC";
