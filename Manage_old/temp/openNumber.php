...
else if (isset($_GET['numSear']))
{
	...
	//搜索出单期的zerc20120803
	$sql = "SELECT g_qishu FROM g_history WHERE g_game_id = 1 and g_qishu='".intval($_GET['numSear'])."' ORDER BY g_qishu DESC ";
                        ...
                        <!-- strat -->
                            ...
                            <table border="0" cellspacing="0" class="conter2" style="display:none" id="NumberList">
                            	<tr class="tr_top">
                                    ...
                                    <td colspan="8" width="400">開出號碼</td>
                                    <td colspan="4">總和</td>
                                    <td>龍虎</td>
                                    <td width="120">基本操作</td>
                            	</tr>
                            	<tr>
                            		<td class="left_p6" colspan="18" style="height:30px">
                            	...
                            	<?php }}?>
                            	<tr>
                					<td colspan="18" class="bj"><?php echo $page->fpage(array(0,1, 3,4,5,6,7))?></td>
                				</tr>
                            </table>
                        <!-- end -->
                        </td>
