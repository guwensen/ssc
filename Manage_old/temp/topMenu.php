...
<!--
	...
	setHtml[3] = 
						<?php if (!isset($Users[0]['g_lock_1_1'])){?>	 
						 ...
						 <?php }?>
                         <?php if (!isset($Users[0]['g_lock_1_1'])){?>
						 '<a href="mrp.php" target="'+target+'">退水默认设置</a>'+
						 <?php }else if (isset($Users[0]['g_lock_1_1']) && $Users[0]['g_lock_1_5'] == 1){?>
						 '<a href="mrp.php" target="'+target+'">退水默认设置</a>'+
						 <?php }?>
						 <?php /* if (!isset($Users[0]['g_lock_1_1'])){?>
	...
	setHtml[11] = '<a href="oddsFilejsk3.php" target="'+target+'">總項盤口</a>'+
							   '<a href="Reckoning.php?tid=9" target="'+target+'">帳單</a>';
