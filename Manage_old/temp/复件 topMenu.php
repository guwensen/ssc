	...
	setHtml[3] = 
						<?php if (!isset($Users[0]['g_lock_1_1'])){?>	 
						 ...
						 '<a href="NumberInclude.php" target="'+target+'">開盤設置</a>'+
						 	 <?php if($iscash){?>
							 '<a href="paycard.php" target="'+target+'">银行卡设置</a> '+
							 '<a href="payrecord.php?payway=0" target="'+target+'">会员充值记录</a> '+
							 '<a href="payrecord.php?payway=1" target="'+target+'">会员汇款记录</a> '+
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
  ...
  <tr>
    <td height="28" colspan="2"><table width="100%" cellspacing="0" cellpadding="0" border="0">
      <tbody><tr>
       <td  nowrap width="130" height="30" style="text-align:left">
	   <input type="button" style="cursor: pointer;" onclick="selectType(1);" name="bST_1" id="bST_1" class="bST_3" value="廣東快樂十分"><input type="button" style="cursor: pointer;" onclick="selectType(2);" name="bST_2" id="bST_2"  class="bST_3" value="重慶時時彩"><input type="button" style="cursor: pointer;" onclick="selectType(3);" name="bST_3" id="bST_3" class="bST_3" value="廣西快樂十分"><input type="button" style="cursor: pointer;" onclick="selectType(6);" name="bST_6" id="bST_6" class="bST_3" value="北京賽車(PK10)"><input type="button" style="cursor: pointer;" onclick="selectType(5);" name="bST_5" id="bST_5" class="bST_3" value="幸运农场"></td>
