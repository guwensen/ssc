										...
										<tbody>
											<tr>
												<td align="right"><a class="T_a" href="topMenu.php"
													...
													target="mainFrame" title="規則說明">規則</a>| 
						<?php
						if ($iscash) {
							?>		
						<a href="paywayEX.php?p=4" class="T_a" target="mainFrame"
													title="充值" style="color: #ff0000">充值</a> | <a
													href="paywayEX.php?p=6" class="T_a" target="mainFrame"
													title="提现" style="color: #ff0000">提现</a> |
						<?php
						}
						?>
						
					<a style="color: #baff00" href="quit.php" class="g" title="安全退出"
													target="_top">退出</a></td>
											</tr>
										</tbody>
									</table>
